...
input_paths = {
    ...
    'squad': {
        'test': './data/squad/test_squad_does_not_exist.jsonl',
    },
    'cpnet': {
...
def main():
    ...
    parser.add_argument('--run', default=['common'], choices=['common', 'csqa', 'hswag', 'anli', 'exp', 'scitail', 'phys', 'socialiqa', 'obqa', 'obqa-fact', 'make_word_vocab', 'squad'], nargs='+')
